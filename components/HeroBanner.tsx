      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in bg-black/30 backdrop-blur-sm rounded-lg p-6">
            ...
            <p className="text-2xl md:text-3xl font-light text-white mt-2 drop-shadow-lg">ADVENTURES</p>
            <p className="text-lg text-white/90 mt-2 drop-shadow-md">Gilgit-Baltistan Specialists</p>
          ...
          <div className="mb-8 animate-slide-up bg-black/20 backdrop-blur-sm rounded-lg p-4">
            <h2 className="text-4xl md:text-6xl font-bold mb-4 animate-fade-in text-white drop-shadow-xl">{slides[currentSlide].title}</h2>
            <p className="text-xl md:text-2xl text-white/95 mb-8 animate-fade-in-delay drop-shadow-lg">
              {slides[currentSlide].subtitle}
            </p>
          </div>

          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 mb-12 max-w-2xl mx-auto bg-black/20 backdrop-blur-sm rounded-lg p-6">
            <div className="text-center animate-bounce-in">
              <div className="text-3xl font-bold text-white drop-shadow-lg">50+</div>
              <div className="text-sm text-white/90 drop-shadow-md">Mountain Routes</div>
            </div>
            <div className="text-center animate-bounce-in" style={{ animationDelay: "0.2s" }}>
              <div className="text-3xl font-bold text-white drop-shadow-lg">2K+</div>
              <div className="text-sm text-white/90 drop-shadow-md">Happy Travelers</div>
            </div>
            <div className="text-center animate-bounce-in" style={{ animationDelay: "0.4s" }}>
              ...
              <div className="text-sm text-white/90 drop-shadow-md">Years Experience</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button
              size="lg"
              className="bg-gradient-to-r from-emerald-500 to-blue-600 hover:from-emerald-600 hover:to-blue-700 text-white px-8 py-4 text-lg font-semibold rounded-full shadow-2xl hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-105"
            >
